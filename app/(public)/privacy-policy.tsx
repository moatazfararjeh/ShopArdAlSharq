...
import { APP_NAME, PRIVACY_POLICY_URL, SUPPORT_EMAIL } from '@/lib/constants';
    ...
    <>
      ...
      >
        ...
        <View style={{ backgroundColor: '#fef3c7', borderWidth: 1, borderColor: '#fde68a', borderRadius: 12, padding: 14, marginBottom: 20 }}>
          ...
          <Pressable onPress={() => Linking.openURL(PRIVACY_POLICY_URL)} style={{ marginTop: 8 }}>
            <Text style={{ fontSize: 14, color: '#2563eb', textDecorationLine: 'underline', textAlign: 'right' }}>
              {PRIVACY_POLICY_URL}
            </Text>
          </Pressable>
        </View>
        ...
        <Section title="2. المعلومات التي نجمعها">
          ...
          <BulletList
            items={[
              ...
              'معلومات الجهاز: نوع الجهاز، نظام التشغيل، معرّفات الجهاز الفريدة، وأذونات الإشعارات أو تسجيل الدخول البيومتري عند استخدامها.',
              'بيانات الاستخدام: الصفحات المعروضة، استعلامات البحث، التفاعل مع المنتجات، وأنماط التنقل في التطبيق.',
              'بيانات الموقع: عناوين التوصيل التي تقدمها. لا نجمع بيانات الموقع الجغرافي في الوقت الفعلي ما لم تكن مطلوبة صراحةً لميزة معينة.',
            ]}
          />
        </Section>
        ...
        <Section title="3. كيف نستخدم معلوماتكم">
          ...
          <BulletList
            items={[
              ...
              'إنشاء وإدارة حسابكم وتقديم خدمات الدعم.',
              'إرسال تأكيدات الطلبات والتحديثات وإشعارات التوصيل.',
              'إرسال اتصالات ترويجية (بموافقتكم) ويمكنكم إلغاء الاشتراك فيها في أي وقت.',
              'تحسين خدمتنا، بما في ذلك توصيات المنتجات المخصصة.',
              'تقديم دعم العملاء وتحليل الأداء والأخطاء.',
        ...
        <Section title="4. مشاركة المعلومات">
          ...
          <BulletList
            items={[
              'مزودو الخدمة: شركات خارجية تساعدنا في تشغيل خدمتنا (مثل شركاء التوصيل، معالجي الدفع، مزودي الاستضافة، ومقدمي البنية التحتية للتخزين والرسائل).',
