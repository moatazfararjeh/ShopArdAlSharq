      ...
      <ScrollView contentContainerStyle={{ padding: 16, gap: 16, paddingBottom: 40 }}>
        ...
        <View style={{ backgroundColor: '#fff', borderRadius: 18, padding: 16, gap: 14 }}>
          ...
          <View>
            ...
            <StyledInput value={sortOrder} onChangeText={setSortOrder} placeholder="0" />
          </View>
        ...
        <TouchableOpacity
          ...
          style={{
            backgroundColor: updateMutation.isPending ? '#d1d5db' : '#f97316',
            borderRadius: 14,
            paddingVertical: 15,
            alignItems: 'center',
            shadowColor: '#f97316',
            shadowOpacity: updateMutation.isPending ? 0 : 0.4,
            shadowRadius: 8,
            elevation: 4,
          }}
        >
